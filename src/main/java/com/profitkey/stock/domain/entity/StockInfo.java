...
public class StockInfo {
    ...
    @Builder
    private StockInfo(StockCode stockCode, String baseDate, BigDecimal endingPrice,
                    Integer openingPrice, Integer highPrice, Integer lowPrice,
                    Long tradingVolume, Long tradingValue, Long marketCap,
                    Integer fiftyTwoWeekHigh, Integer fiftyTwoWeekLow,
                    BigDecimal per, Integer eps, BigDecimal pbr, Integer bps) {
